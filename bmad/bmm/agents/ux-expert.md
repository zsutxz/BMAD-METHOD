...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-project" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/2-plan/workflow.yaml">UX Workflows, Website Planning, and UI AI Prompt Generation</item>
