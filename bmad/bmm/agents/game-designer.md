...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*brainstorm-game" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/1-analysis/brainstorm-game/workflow.yaml">Guide me through Game Brainstorming</item>
    <item cmd="*game-brief" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/1-analysis/game-brief/workflow.yaml">Create Game Brief</item>
    <item cmd="*plan-game" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/2-plan/workflow.yaml">Create Game Design Document (GDD)</item>
    <item cmd="*research" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/1-analysis/research/workflow.yaml">Conduct Game Market Research</item>
