...
<activation critical="MANDATORY">
  ...
  <handler type="validate-workflow">
    ...
    1. You MUST LOAD the file at: /Users/brianmadison/dev/BMAD-METHOD/bmad/core/tasks/validate-workflow.xml
  ...
  <menu>
    ...
    <item cmd="*correct-course" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/4-implementation/correct-course/workflow.yaml">Execute correct-course task</item>
    <item cmd="*create-story" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Create a Draft Story with Context</item>
    <item cmd="*story-context" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/4-implementation/story-context/workflow.yaml">Assemble dynamic Story Context (XML) from latest docs and code</item>
    <item cmd="*validate-story-context" validate-workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/4-implementation/story-context/workflow.yaml">Validate latest Story Context XML against checklist</item>
    <item cmd="*retrospective" workflow="/Users/brianmadison/dev/BMAD-METHOD/bmad/bmm/workflows/4-implementation/retrospective/workflow.yaml" data="/Users/brianmadison/dev/BMAD-METHOD/bmad/_cfg/agent-party.xml">Facilitate team retrospective after epic/sprint</item>
